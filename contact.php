...
<body>
    <header>
        <div class="topHeader">
            <p class="headerTitle">The Powe<a href="random_picker_v2 copie 2/index.html" class="navLinks">r</a>of Memory</p>
            <p class="nav">
                <a class="navLinks" href="PoMindex.html">ACCUEIL</a>
                <a class="navLinks" href="memory.html">JEU</a>
                <a class="navLinks" href="score.html">SCORES</a>
                <a class="navLinks" href="contact.html">NOUS CONTACTER</a>
                <a class="navLinks" href="login.html">MON ESPACE</a>
            </p>
        </div>
        <div class="title">
            <div class="titleBG"> 
                <p class="inscTitle">NOUS CONTACTER</p>
            </div>
        </div>
    </header>
    ...
    <section class="main">
        ...
        <div class="forms">
            <form action="" method="post">
                ...
                <textarea class="textInput" placeholder="Message" type="message" name="message"></textarea>
