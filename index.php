...
<body>
    ...
    <section class="section2">
        <article class="thirdMain">
            ...
            <div class="stats">
                <div class="firstLine"><p class="firstSquare">100<br>Partie Jouées</p><p class="secondSquare">100<br>Joueurs Connectés</p><br></div>
                <div class="secondLine"><p class="thirdSquare">100<br>Temps Record</p><p class="fourthSquare">100<br>Joueurs Inscrits</p></div>
            </div>
        </article>
        <div class="fourthMain">
            ...
            <div class="teamPictures">
                <p class="PictureBox"><img src="style/assets/arab rat copie.jpeg" class="Picture">RAT<span class="white"><br>Kebab Remover</span></p>
                <p class="PictureBox"><img src="style/assets/funny rat copie.jpeg" class="Picture">RAT<span class="white"><br>Mastermind</span></p>
                <p class="PictureBox"><img src="style/assets/funny dog copie.jpeg" class="Picture">RAT?<span class="white"><br>Undercover Agent</span></p>
            </div>
        </div>
    </section>
